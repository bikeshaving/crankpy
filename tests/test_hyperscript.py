...
def test_conditional_elements():
    ...
    show_title = True
    content = [h.h1["Title"] if show_title else None, h.p["Always shown"]]
...
def test_fragment_syntax():
    ...
    fragment = h(Fragment)[h.div["First"], h.div["Second"]]
...
def test_boolean_attributes():
    ...
    input_elem = h.input(type="checkbox", checked=True, disabled=False, required=True)
...
def test_special_elements():
    ...
    from crank import Copy, Portal, Raw, Text, h
